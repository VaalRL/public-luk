...
INSERT INTO "new_Transaction" ("anomalyFlags", "anomalyScore", "balance", "bankStatementId", "createdAt", "date", "deposit", "description", "id", "note", "reviewStatus", "status", "updatedAt", "withdrawal") SELECT "anomalyFlags", "anomalyScore", "balance", "bankStatementId", "createdAt", "date", "deposit", "description", "id", "note", "reviewStatus", "status", "updatedAt", "withdrawal" FROM "Transaction";
