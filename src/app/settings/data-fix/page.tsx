...
export default function DataFixPage() {
    ...
    return (
        <div className="container mx-auto p-6 space-y-6">
            <div>
                <h1 className="text-3xl font-bold">{t("dataFix.title")}</h1>
                <p className="text-muted-foreground">{t("dataFix.description")}</p>
            </div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{t("dataFix.step1Title")}</CardTitle>
                    <CardDescription>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{t("dataFix.step2Title")}</CardTitle>
                    <CardDescription>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{t("dataFix.guide")}</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2 text-sm">
                    <p>
                        <strong>{t("dataFix.causeLabel")}</strong>
                        {t("dataFix.causeText")}
                    </p>
                    <p>
                        <strong>{t("dataFix.flowLabel")}</strong>
                    </p>
                    <ol className="list-decimal list-inside space-y-1 ml-4">
                        <li>{t("dataFix.flow1")}</li>
                        <li>{t("dataFix.flow2")}</li>
                        <li>{t("dataFix.flow3")}</li>
                    </ol>
                    <p className="text-amber-600">
                        <strong>{t("dataFix.importantLabel")}</strong>
                        {t("dataFix.importantText")}
                    </p>
                </CardContent>
            </Card>
        </div>
